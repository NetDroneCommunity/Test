...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		...
		public const INT	iCHANNEL_NAME_LEN = 255;
		public const INT	iSERVER_NAME_LEN = 255;
		public const INT	iSERVER_OPTION_LEN = 255;
		public const INT	iSERVER_DOMAIN_LEN = 255;
