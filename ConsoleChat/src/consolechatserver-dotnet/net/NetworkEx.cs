...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		public class CMasterNetwork : CNetwork {
			public CMasterNetwork() { }
			~CMasterNetwork() { }
			...
			ParseCommand(CExtendCommand kCommand_) {
				...
				if(((UINT)PROTOCOL.PROTOCOL_COMMON_BEGIN < kCommand.GetOrder()) && (kCommand.GetOrder() < (UINT)PROTOCOL.PROTOCOL_COMMON_END)) {
		...
		public class CSlaveNetwork : CNetwork {
			public CSlaveNetwork() { }
			~CSlaveNetwork() { }
