...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		...
		public struct SIdAuthorizeClToGs {
			...
			public void		SetLoginId(CHAR[] o)		{ INT iLength = o.Length; if(iLOGIN_ID_LEN < iLength) { iLength = iLOGIN_ID_LEN; } Array.Copy(o, 0, login_id, 0, iLength); login_id[iLength] = (CHAR)('\0'); }
