...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		public delegate bool	NativeLauncher(CUnit o, CCommand p);
		...
		public static void
		ServerLauncher(CUnit kActor_, CCommand kCommand_) {
		...
		public static void
		ServerLauncher(CExtendCommand kCommand_) {
