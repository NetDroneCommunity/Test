...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		public static CRoomProvider	g_kRoomProvider { get { return CRoomProvider.GetInstance(); } }

		public class CRoomProvider : CSingleton< CRoomProvider > {
			public CRoomProvider() { inner.Clear(); }
			~CRoomProvider() { inner.Clear(); }
