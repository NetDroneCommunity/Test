...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		public class CPlayer : CUnit {
			...
			public void					ClearPlayerData()			{ m_tPlayerData.ClearPlayerData(); }
			public void					SetPlayerData(SPlayerData o)	{ m_tPlayerData.Reset(o); }
			public void					SetPlayerSums(SPlayerData o)	{ m_tPlayerSums.Reset(o); }
			...
			public void					SetLoginId(CHAR[] o)		{ INT iLength = o.Length; if(iLOGIN_ID_LEN < iLength) { iLength = iLOGIN_ID_LEN; } Array.Copy(o, 0, m_szLoginId, 0, iLength); m_szLoginId[iLength] = (CHAR)('\0'); }
