...
namespace CompatibilityStandards {
	...
	public partial class GameFramework {
		...
		public enum LANGUAGE_TYPE {
			...
			LANGUAGE_ENGLISH,
			LANGUAGE_NONE,
			LANGUAGE_MAX = LANGUAGE_NONE
		}

		public enum RELAY_TYPE {
			RELAY_DEFAULT_BEGIN = 0,
			RELAY_CLIENT = RELAY_DEFAULT_BEGIN,
			RELAY_DEFAULT_END = RELAY_CLIENT,

			RELAY_BACKBONE_BEGIN,
			RELAY_SERVER = RELAY_BACKBONE_BEGIN,
			RELAY_BACKBONE_END = RELAY_SERVER,
			RELAY_NONE,
			RELAY_MAX = RELAY_NONE
		}
